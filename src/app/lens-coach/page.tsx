...
import { Camera, Upload, Star, Lightbulb, Loader2, CheckCircle, ImagePlus, ArrowLeft } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Lens Coach — المدرب البصري</h1>
              ...
              >
                ...
                {file ? (
                  <div className="flex items-center justify-center gap-3">
                    <ImagePlus className="w-8 h-8 text-green-400" />
                  ...
                  <>
                    ...
                    {isDragActive ? (
                      <p className="text-green-400 text-lg">أفلت الصورة هنا...</p>
                    ) : (
                      <>
