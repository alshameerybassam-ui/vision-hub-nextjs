...
import { Camera, Palette, Brush, Sparkles, Send, Loader2, ImageIcon } from 'lucide-react'
    ...
    return (
      <div className="min-h-screen pt-24 pb-12 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Sparkles className="w-16 h-16 text-vh-accent mx-auto mb-4" />
            ...
            <div className="glass rounded-2xl p-8 mb-8">
              <div className="aspect-video bg-gradient-to-br from-vh-accent/20 to-purple-500/20 rounded-xl flex items-center justify-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button className="px-6 py-3 bg-vh-accent text-white rounded-xl hover:bg-vh-accent-hover transition-colors">
                تحميل التصميم
              </button>
            </div>
          </motion.div>
  ...
  return (
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="w-16 h-16 bg-vh-accent/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Sparkles className="w-8 h-8 text-vh-accent" />
          </div>
          <h1 className="text-4xl font-bold text-white mb-4">FrameAI</h1>
          ...
          {steps.map((_, i) => (
            <div
              ...
              className={`h-2 flex-1 rounded-full transition-colors ${
                i + 1 <= step ? 'bg-vh-accent' : 'bg-white/10'
              }`}
            />
          ))}
        </div>
              ...
              <button
                ...
                className={`p-6 rounded-xl border-2 transition-all ${
                  selections[currentStep.category] === opt.id
                    ? 'border-vh-accent bg-vh-accent/10'
          ...
          <div className="flex justify-between mt-8">
            ...
            {step < 4 ? (
              <button
                ...
                className="px-6 py-3 bg-vh-accent text-white rounded-xl hover:bg-vh-accent-hover transition-colors disabled:opacity-50 mr-auto"
              >
                التالي
              </button>
            ) : (
              <button
                ...
                className="px-6 py-3 bg-vh-accent text-white rounded-xl hover:bg-vh-accent-hover transition-colors disabled:opacity-50 mr-auto inline-flex items-center gap-2"
              >
                {generating ? (
                  <>
