...
import { Upload, Image, Wand2, Download, CheckCircle, Loader2 } from 'lucide-react'
    ...
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Revive</h1>
        ...
        >
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-12 text-center cursor-pointer transition-all ${
              isDragActive
                ? 'border-vh-accent bg-vh-accent/5'
          ...
          >
            ...
            {isDragActive ? (
              <p className="text-vh-accent text-lg">أفلت الصور هنا...</p>
            ) : (
              <>
        ...
        {files.length > 0 && !completed && (
          ...
          >
            <button
              ...
              disabled={processing}
              className="px-8 py-4 bg-amber-500 text-white rounded-xl hover:bg-amber-600 transition-colors font-semibold disabled:opacity-50 inline-flex items-center gap-2"
            >
              {processing ? (
                <>
